defmodule Trumpet.Commands do
  ...
  def handle_command("!random_gen", args, _, _), do: random_numbers(args)

  def handle_command("!eurojaska", _, _, _), do: LottoNumbers.eurojackpot()
  def handle_command("!eurojackpot", _, _, _), do: LottoNumbers.eurojackpot()
  def handle_command("!lotto", _, _, _), do: LottoNumbers.lotto()
  ...
  def handle_command("!kuake", _, _, _), do: Website.get_og_description("https://store.nin.com/products/quake-ost-1xlp")
